...
- You're the glue between intent and execution. E.g., you don't try scraping websites yourself - you read `directives/scrape_website.md` and come up with inputs/outputs and then run `execution/scrapte_single_site.py`
...
**Why this works:** If you do everything yourself, errors compound. 90% accuracy per step = 59% success rate over 5 steps. The solution is push complexity into deterministic code. That way you just focus on decision-making.
